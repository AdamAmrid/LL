  ...
  return (
    <div>
      ...
      <div className="bg-white relative overflow-hidden">
        ...
        {/* Helper Div to center content vertically/horizontally if needed, but Section handles max-width */}
        <div className="relative z-10 py-20 sm:py-28">
          <Section className="!px-0"> {/* Override padding if needed or rely on Section's defaults */}
      ...
      <Section id="mission" title="Our Mission" className="py-16">
        <div className="bg-gradient-to-br from-white to-secondary rounded-2xl p-8 sm:p-10 shadow-um6p border border-gray/10">
      ...
      <Section id="support" title="What We Support" className="py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {supportTypes.map(({ icon: Icon, title, desc, emoji, color }, idx) => (
            <div
              key={idx}
              className="bg-white rounded-xl p-6 shadow-um6p border border-gray/10 hover:shadow-lg hover:-translate-y-2 hover:border-accent/30 transition-all duration-300 cursor-default group"
            >
